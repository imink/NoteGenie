          ...
          <div className="space-y-6">
            ...
            {isAIAvailable ? (
              ...
              <div className="bg-gray-50 p-4 rounded-xl border-2 border-dashed border-gray-300">
                <label className="block text-sm font-semibold text-gray-500 flex items-center mb-2">
                  <Wand2 className="w-4 h-4 mr-2" />
                  AI Content Generator
                </label>
                <p className="text-xs text-gray-500">Configure an API key to enable AI-powered content generation.</p>
              </div>
            )}
          ...
          <div className="space-y-8">
            ...
            {isAIAvailable ? (
              ...
              <div className="bg-gray-50 p-4 rounded-xl border-2 border-dashed border-gray-300">
                ...
                <p className="text-xs text-gray-500">Configure an API key to enable AI-powered background generation.</p>
              </div>
            )}
